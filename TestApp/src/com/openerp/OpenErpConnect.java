...
public class OpenErpConnect {
    ...
    public static Boolean testConnection(String server, Integer port, String db, String user, String pass) throws ClassCastException{
    ...
    public HashMap<String, Object> fieldsViewGet(String model) {
    ...
    public HashMap<String, Object> fieldsGet(String model) {
        HashMap<String, Object> fieldValue = null;
        try {
            XMLRPCClient client = new XMLRPCClient(mUrl);
